  ...
  namespace io
  {
    ...
    */
    ...
    public:
      ...
      // Construct a stream with explicit file mode (repeating code, but no way to provide default value for the
      // second argument)
      ...
      // Open a stream with explicit file mode (repeating code, but no way to provie default value for the second...
      // ...argument)
